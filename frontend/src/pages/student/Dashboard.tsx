...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl}/student/dashboard`, {
      ...
      .catch(err => {
        console.error(err);
        toast.error("Error loading dashboard data. Are you logged in?");
      })
  ...
  const { applications = [], openDrives = [], upcomingInterview, certifications = 0, skills = 0, cgpa = "0.0" } = data || {};
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-foreground">TCS Online</p>
              </div>
            </div>
          </CardContent>
        </Card>
